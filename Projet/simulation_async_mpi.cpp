...
///////
    ...
    while (!quitting)
    {
        ...
        màjStatistique(grille, population);
            ...
            MPI_Allreduce(envoie.data(),statistiques.data(), 3*largeur_grille*hauteur_grille, MPI_INT, MPI_SUM, new_comm);
        ...
        for ( auto& personne : population )
        {
            ...
            if(my_new_comm_rank==0){
                ...
                MPI_Isend(statistiques.data(),3*largeur_grille*hauteur_grille,MPI_INT,0,0, MPI_COMM_WORLD,&request);
                }
            }
